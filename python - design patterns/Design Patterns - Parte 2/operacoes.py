...
class Subtracao(object):
    ...
    def __init__(self, espressao_esquerda, expressao_direita):
        self.__expressao_esquerda = espressao_esquerda
...
if __name__ == '__main__':
    ...
    expressao_conta_2 = Subtracao(Numero(100), Numero(70))
    print(expressao_conta_2.avalia())
